...
% Converts MT lengths to region boundaries in a tubular domain
% Inputs:
% mtlens - microtubule lengths (nmt x 1)
% mtrad - mt capture radius
% Dc - diffusion coefficient
% bulkcapture - allow capture on MT bulk?
% domrad - domain radius
...
% one sided (default): MT tip region extends from mtlens to mtlens-2*mtrad
% two sided: MT tip region extends from mtlens+mtrad to
% mtlens-mtrad
opt.onesided = true;
% add extra absorbing region near soma?
...
if(opt.use3Drate)
	% use capture rates obtained from simulations with randomly dispersed MTs
